...
describe('Post\'s', () => {
    ...
    it('should update Visibility from none to anonymous', async () => {
        const newUid = await user.create({ username: 'newuser' });
        const postResult = await topics.post({ uid: newUid, cid, title: 'Test Anonymity', content: 'This is a test for anonmoity.', isAnonymous: 'anonymous' });
    ...
    it('should check if the typeOfPost is originally public ', async () => {
        ...
        const post = await posts.create({ uid: testUser2, cid, title: 'Test Title 1', content: 'This is a test post!', typeOfPost: 'public' });
    ...
    it('should update typeOfPost from public to private', async () => {
        ...
        const post = await posts.create({ uid: testUser, cid, title: 'Test Title', content: 'This is a test post.', typeOfPost: 'private' });
        const { pid } = post;
    ...
    describe('voting', () => {
        ...
        it('should get voters', (done) => {
            socketPosts.getVoters({ uid: globalModUid }, { pid: postData.pid, cid }, (error, data) => {
                assert.ifError(error);
        ...
        it('should get upvoters', (done) => {
            socketPosts.getUpvoters({ uid: globalModUid }, [postData.pid], (error, data) => {
                assert.ifError(error);
    ...
    describe('post tools', () => {
        it('should error if data is invalid', (done) => {
            socketPosts.loadPostTools({ uid: globalModUid }, null, (error) => {
        ...
        it('should load post tools', (done) => {
            socketPosts.loadPostTools({ uid: globalModUid }, { pid: postData.pid, cid }, (error, data) => {
                assert.ifError(error);
    ...
    describe('post queue', () => {
        ...
        it('should error if data is invalid', (done) => {
            socketPosts.editQueuedContent({ uid: globalModUid }, null, (error) => {
                assert.equal(error.message, '[[error:invalid-data]]');
                done();
            });
        });
        ...
        it('should edit post in queue', (done) => {
            socketPosts.editQueuedContent({ uid: globalModUid }, { id: queueId, content: 'newContent' }, (error) => {
                assert.ifError(error);
                request(`${nconf.get('url')}/api/post-queue`, { jar, json: true }, (error, res, body) => {
                    assert.ifError(error);
                    assert.equal(body.posts[1].type, 'reply');
        ...
        it('should edit topic title in queue', (done) => {
            socketPosts.editQueuedContent({ uid: globalModUid }, { id: topicQueueId, title: 'new topic title' }, (error) => {
                assert.ifError(error);
                request(`${nconf.get('url')}/api/post-queue`, { jar, json: true }, (error, res, body) => {
                    assert.ifError(error);
                    assert.equal(body.posts[0].type, 'topic');
        ...
        it('should edit topic category in queue', (done) => {
            socketPosts.editQueuedContent({ uid: globalModUid }, { id: topicQueueId, cid: 2 }, (error) => {
                assert.ifError(error);
                request(`${nconf.get('url')}/api/post-queue`, { jar, json: true }, (error, res, body) => {
                    assert.ifError(error);
                    assert.equal(body.posts[0].type, 'topic');
                    assert.equal(body.posts[0].data.cid, 2);
                    socketPosts.editQueuedContent({ uid: globalModUid }, { id: topicQueueId, cid }, (error_) => {
        ...
        it('should not crash if id does not exist', (done) => {
            socketPosts.reject({ uid: globalModUid }, { id: '123123123' }, (error) => {
                assert.equal(error.message, '[[error:no-privileges]]');
                done();
            });
        });
