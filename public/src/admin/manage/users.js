...
define('admin/manage/users', [
    ...
    Users.init = function () {
            ...
            socket.emit('admin.user.loadGroups', uids, (error, data) => {
                ...
                Benchpress.render('admin/partials/manage_user_groups', data).then((html) => {
                    ...
                    modal.on('shown.bs.modal', () => {
                        autocomplete.group(modal.find('.group-search'), (ev, ui) => {
                ...
                bootbox.dialog({
                    ...
                    buttons: {
                        ...
                        submit: {
                            ...
                            callback() {
                                const formData = $('.ban-modal form').serializeArray().reduce((data, cur) => {
        ...
        const actionBtn = document.querySelector('#action-dropdown');
