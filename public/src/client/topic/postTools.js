...
define('forum/topic/postTools', [
	...
	PostTools.toggle = function (pid, isDeleted) {
		...
		postElement.find('[component="post/quote"], [component="post/bookmark"], [component="post/reply"], [component="post/flag"], [component="user/chat"]')
	...
	function addPostHandlers(tid) {
		...
		postContainer.on('click', '[component="post/edit"]', function () {
			...
			const timestamp = Number.parseInt(getData(btn, 'data-timestamp'), 10);
