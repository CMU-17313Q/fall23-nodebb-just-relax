<div component="composer" class="composer<!-- IF resizable --> resizable<!-- ENDIF resizable --><!-- IF !isTopicOrMain --> reply<!-- ENDIF !isTopicOrMain -->"<!-- IF !disabled --> style="visibility: inherit;"<!-- ENDIF !disabled -->>
    ...
    <div class="form-check">
			...
			<input class="form-check-input" type="checkbox" value="" id="postAnonymouslyCheckbox">
			<label class="form-check-label" for="postAnonymouslyCheckbox">
				Post Anonymously
			</label>
			</br>
			<input class="form-check-input" type="checkbox" value="" id="postPrivatelyCheckbox">
			<label class="form-check-label" for="postPrivatelyCheckbox">
				Post Privately
			</label>
