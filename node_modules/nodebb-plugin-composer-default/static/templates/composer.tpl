	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<label>
				...
				<br>
				<input class="form-check-input" type="radio" name="visibility" value="anonymous" id="postAnonymouslyRadio">
				<label class="form-check-label" for="postAnonymouslyRadio">
					Post Anonymously
				</label>
				<br>
				<input class="form-check-input" type="radio" name="visibility" value="private" id="postPrivatelyRadio">
