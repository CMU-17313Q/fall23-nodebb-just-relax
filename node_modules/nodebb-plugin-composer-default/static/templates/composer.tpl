	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<div class="form-check">
				...
				<br>
				<input class="form-check-input" type="checkbox" name="visibility" value="anonymous" id="postAnonymouslyRadio">
				<label class="form-check-label" for="postAnonymouslyRadio">
					Post Anonymously
				</label>
				<br>
				<input class="form-check-input" type="checkbox" name="visibility" value="private" id="postPrivatelyRadio">
				<label class="form-check-label" for="postPrivatelyRadio">
					Post Privately
				</label>
		    </div>
