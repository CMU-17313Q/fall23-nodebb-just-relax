		...
		<div class="row title-container">
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" href="#" data-value="Public" data-action="post">Public</a>
					<br> <!-- Add line break here -->
					<a class="dropdown-item" href="#" data-value="Private" data-action="post">Private</a>
				</div>
			</div>
			...
			$('.dropdown-item').click(function() {
				...
				$('#dropdownMenuButton').html(selectedOption);
			});
			});
			</script>
			...
			<div class="btn-group pull-right action-bar hidden-sm hidden-xs">
				...
				<button class="btn btn-primary composer-submit-anonymously" data-action="post" tabindex="6" data-text-variant=" [[topic:composer.schedule]]"></i>or Submit Anonymously</button>
