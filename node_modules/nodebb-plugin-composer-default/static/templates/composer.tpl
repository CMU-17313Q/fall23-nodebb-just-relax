	...
	<div class="composer-container">
		...
		<div class="row title-container">
			...
			<label>
				...
				<br>
				<input class="form-check-input" type="checkbox" value="anonymous" id="postAnonymouslyRadio">
				<label class="form-check-label" for="postAnonymouslyRadio">
					Post Anonymously
				</label>
				<br>
				<input class="form-check-input" type="checkbox" value="private" id="postPrivatelyRadio">
