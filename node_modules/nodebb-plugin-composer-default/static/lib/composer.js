...
define('composer', [
	...
	async function post(post_uuid) {
		...
		// var for private --maria
		var isPrivate = postContainer.find('#postPrivatelyRadio');
		var isAnon = postContainer.find("#postAnonymouslyRadio");
		const submitBtn = postContainer.find('.composer-submit');

		let isAnonymous = 'None';

		if (isAnon.prop('checked')) {
