...
module.exports = function () {
    ...
    // Route for marking posts as resolved. Calls 'resolve' function from controller. -huda
    setupApiRoute(router, 'put', '/:pid/resolve', [middleware.assert.post], controllers.write.posts.resolve);
